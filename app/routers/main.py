...
async def run_migrations(pool):
    async with pool.acquire() as conn:
        await conn.execute("""
            ...
            ALTER TABLE materials ADD COLUMN IF NOT EXISTS qty_stock NUMERIC(10,4) NOT NULL DEFAULT 0;
            ALTER TABLE sales ADD COLUMN IF NOT EXISTS labor NUMERIC(10,2) NOT NULL DEFAULT 0;
            ALTER TABLE sales ADD COLUMN IF NOT EXISTS labor_desc TEXT;
        """)
